...
{
    /// <inheritdoc />
    public partial class ATWebCtx : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MidleNameName = table.Column<string>(type: "nvarchar(50)", nullable: false),
                    ...
                    Zip = table.Column<string>(type: "nvarchar(50)", nullable: false),
                    Email = table.Column<string>(type: "nvarchar(50)", nullable: false),
                    Contact = table.Column<string>(type: "nvarchar(50)", nullable: false),
                    AlternateContact = table.Column<string>(type: "nvarchar(50)", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(50)", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderBy = table.Column<string>(type: "nvarchar(50)", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Role_Screens", x => new { x.RoleId, x.ScreenId });
                    table.ForeignKey(
                        name: "FK_Role_Screens_Roles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "Roles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Role_Screens_Screens_ScreenId",
                        column: x => x.ScreenId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Inventory_Sellers_SellerId",
                        column: x => x.SellerId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Dimesions = table.Column<string>(type: "nvarchar(50)", nullable: false),
                    Price = table.Column<string>(type: "nvarchar(50)", nullable: false),
                    FileFolder = table.Column<string>(type: "nvarchar(50)", nullable: false),
                    FilePath = table.Column<string>(type: "nvarchar(50)", nullable: false),
                    Type = table.Column<string>(type: "nvarchar(50)", nullable: false),
                    Weight = table.Column<string>(type: "nvarchar(50)", nullable: false),
